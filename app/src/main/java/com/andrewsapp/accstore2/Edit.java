...
// finally change the color
        ...
        intent=getIntent();
        row=(RowDB) intent.getSerializableExtra("editrow");
        database=new Database(this);

        selectIcon=(ImageView)this.findViewById(R.id.selectIconEdit);
        close=(ImageView)this.findViewById(R.id.closeEdit);
        save=(TextView) this.findViewById(R.id.saveEdit);
        til=(TextInputLayout)this.findViewById(R.id.inputLayEdit);
        tie=(TextInputEditText)this.findViewById(R.id.titleeditId);
        acc=(TextInputEditText)this.findViewById(R.id.accounteditId);
        user=(TextInputEditText)this.findViewById(R.id.usernameeditId);
        pass=(TextInputEditText)this.findViewById(R.id.passeditId);
        web=(TextInputEditText)this.findViewById(R.id.websiteeditId);
        aditional=(TextInputEditText)this.findViewById(R.id.aditionaleditId) ;

        darkenGreen=(LinearLayout)this.findViewById(R.id.DarkenColorGreen);
        darkenWhite=(LinearLayout)this.findViewById(R.id.DarkenColorWhite);
        ...
        if(row.getIcon()!=null){
            selectIcon.setImageDrawable(Tools.byte2Drawable(row.getIcon(),this));
            icon=row.getIcon();
            color_light=row.getColor_light();
            color_dark=row.getColor_dark();
        ...
        tie.setText(row.getTitle());
        acc.setText(row.getAccount());
        user.setText(row.getUsername());
        pass.setText(row.getPass());
        web.setText(row.getWebsite());
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validate_name()) {
                    ...
                    newRow.setAccount(account);
                    newRow.setUsername(username);
                    newRow.setPass(password);
                    newRow.setWebsite(website);
                    newRow.setAditionalinfo(aditionalinfo);
                    newRow.setDate(date);
                    newRow.setIcon(icon);
                    newRow.setColor_light(color_light);
                    newRow.setColor_dark(color_dark);

                    Tools.IS_ICON_SELECTED=0;//bug
                    long id = database.updateRow(newRow);

                    Intent intent = new Intent(Edit.this, Accounts.class);
